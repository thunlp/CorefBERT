...
from transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForQuestionAnsweringForMRQA, BertTokenizer,
                                  RobertaConfig, RobertaForQuestionAnsweringForMRQA, RobertaTokenizer)
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForQuestionAnsweringForMRQA, BertTokenizer),
    "roberta": (RobertaConfig, RobertaForQuestionAnsweringForMRQA, RobertaTokenizer),
}
