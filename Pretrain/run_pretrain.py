...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForCopy, BertTokenizer),
    'roberta': (RobertaConfig, RobertaForCopy, RobertaTokenizer),
}

class InputFeatures(object):
    """A single set of features of data."""

    def __init__(self, input_ids, attention_mask, final_items, example_idx):
...
class TextDataset(Dataset):
    def __init__(self, tokenizer, corpus_path="wikipedia_traindata", max_seq_length=512, overwrite_cache=False, evaluate=False):
